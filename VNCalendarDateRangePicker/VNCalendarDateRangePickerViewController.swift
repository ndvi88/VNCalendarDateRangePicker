//
//  VNCalendarDateRangePickerViewController.swift
...
public class VNCalendarDateRangePickerViewController: UICollectionViewController {
    ...
    override public func viewDidLoad() {
        ...
        collectionView?.register(VNCalendarDateRangePickerCell.self, forCellWithReuseIdentifier: cellReuseIdentifier)
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(VNCalendarDateRangePickerViewController.didTapCancel))
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Done", style: .done, target: self, action: #selector(VNCalendarDateRangePickerViewController.didTapDone))
...
extension VNCalendarDateRangePickerViewController {
    ...
    override public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellReuseIdentifier, for: indexPath) as! VNCalendarDateRangePickerCell
...
extension VNCalendarDateRangePickerViewController : UICollectionViewDelegateFlowLayout {
    
    override public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let cell = collectionView.cellForItem(at: indexPath) as! VNCalendarDateRangePickerCell
        if cell.date == nil {
            return
        }
